...
from app.routers.shopify_mapeamento import router as shopify_mapear_router
...
app.include_router(guru_mapear_router)
app.include_router(shopify_mapear_router)
